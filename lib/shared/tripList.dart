...
class _TripListState extends State<TripList> {
  ...
  void _addTrips() {
    // get data from db
    List<Trip> _trips = [
      Trip(title: 'Beach Paradise', price: '350', night: '3', img: 'beach.png'),
      Trip(title: 'City Break', price: '400', night: '5', img: 'city.png'),
      Trip(title: 'Ski Adventure', price: '750', night: '2', img: 'ski.png'),
      Trip(title: 'Space Blast', price: '600', night: '4', img: 'space.png'),
    ];
